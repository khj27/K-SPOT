...
const researchLabels: Record<string, string> = { slug: "고유 주소 (자동 생성 · 수정 가능)", contentTitle: "미디어 제목", contentType: "미디어 유형", creator: "관련 연예인 이름", releaseYear: "미디어 공개연도", episode: "등장 장면", description: "장소 소개 및 조사 정보", spotName: "장소명", region: "지역 (주소에서 추출 · 확인 필요)", address: "정확한 주소", latitude: "위도 (필수)", longitude: "경도 (필수)", sourceUrl: "정보 출처 URL", sourceLabel: "출처명", verifiedAt: "검수일 (필수)", imageUrl: "직접 이미지 URL (선택)", imageRights: "이미지 사용 권리·근거 (필수)" };
