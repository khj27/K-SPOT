...
export function SavedItinerariesList({ contents, createdId }: { contents: ExploreContent[]; createdId?: string }) {
  ...
  return (
    <section className="saved-itineraries">
      ...
      <ConfirmDialog open={!!pendingDelete} busy={deleting} onCancel={() => setPendingDelete(null)} onConfirm={() => { if (pendingDelete) void removeItinerary(pendingDelete); }} />
