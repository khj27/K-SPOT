...
export default async function LoginPage() {
  ...
  return <main className="saved-page account-login-page"><section className="saved-heading"><div><p className="kspot-eyebrow">K-SPOT ACCOUNT</p><h1>나의 여행 계정</h1><p>이메일로 가입하고 다른 기기에서도 여행 자료를 불러오세요.</p></div></section><UserLoginForm configured={configured} /></main>;
}
