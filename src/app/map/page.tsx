...
export default async function MapPage({ searchParams }: MapPageProps) {
  ...
  return (
    <main className="map-page">
      ...
      {contents.length > 0 ? <MapExplorer appKey={process.env.NEXT_PUBLIC_KAKAO_MAP_KEY ?? ""} contents={contents} /> : <section className="map-empty"><AppIcon name="map" size={32} /><h2>조건에 맞는 촬영지가 없습니다.</h2><p>필터를 바꿔 다시 검색해 보세요.</p><a href="/map">전체 지도 보기</a></section>}
