    ...
    <main className="planner-page">
      ...
      <Form className="planner-form" action="/planner/result">
        ...
        <fieldset>
          ...
          <div className="planner-field-grid"><label><span><LocaleText>여행 제목</LocaleText></span><input name="title" maxLength={120} /></label>
            ...
            <label><span><LocaleText>여행 인원</LocaleText></span><input type="number" name="peopleCount" min="1" max="100" step="1" defaultValue="1" required /></label>
          </div>
        </fieldset>
        <fieldset>
